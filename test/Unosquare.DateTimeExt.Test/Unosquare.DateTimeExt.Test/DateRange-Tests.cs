...
public class DateRangeTests
{
    ...
    {
        var dateRange = new DateRange(new DateTime(2022, 10, 1), new DateTime(2022, 10, 31));
        dateRange.Deconstruct(out var startDate, out var endDate);

        Assert.Equal(new DateTime(2022, 10, 1), startDate);
        Assert.Equal(new DateTime(2022, 10, 31), endDate);
    }

    [Fact]
    public void WithYearQuarter_ReturnsFormattedString()
    {
        Assert.Equal("10/1/2022 12:00:00 AM-10/31/2022 12:00:00 AM",
            new DateRange(new DateTime(2022, 10, 1), new DateTime(2022, 10, 31)).ToString());
    }

    [Fact]
    public void WithDateRange_GetEnumerator()
    {
        var dateRangeEnumerator = new DateRange(new DateTime(2022, 10, 1), new DateTime(2022, 10, 31)).GetEnumerator();

        Assert.True(dateRangeEnumerator.MoveNext());
        Assert.Equal(new DateTime(2022, 10, 1), dateRangeEnumerator.Current);
        Assert.True(dateRangeEnumerator.MoveNext());
        Assert.Equal(new DateTime(2022, 10, 2), dateRangeEnumerator.Current);
    }
    ...
    public void WithDateRanges_Equals()
    {
        ...
        var dateRange2 = new DateRange(new DateTime(2022, 10, 1), new DateTime(2022, 10, 31));
        var dateRange3 = new DateRange(new DateTime(2022, 10, 2), new DateTime(2022, 10, 31));
